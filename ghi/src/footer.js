  ...
  useEffect(() => {
    const interval = setInterval(() => {
      const texts = [
        ...
        "What do you get when you cross a sock and a clock? A tick-toe sockclock!",
        "Why did the sock refuse to be worn? It wanted to be left footloose and fancy-free!",
        "What's a sock's favorite dessert? Foot-ernut squash!",
        "Why did the sock break up with its girlfriend? She wasn't dirty enough!",
        ...
        "How does a sock make monbey? It trades in the sock market!",
        ...
        "Why did the sock go to the concert? It wanted to rock out with its sock out!",
        ...
        "What do you call a sock that's really messy? A dis-sock-aray!",
